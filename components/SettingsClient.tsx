        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <input
              type="text"
              name="company_name"
              defaultValue={settings.company_name || 'THABBA Travel & Tour Pvt Ltd'}
          ...
          <div>
            ...
            <input
              type="text"
              name="phone"
              defaultValue={settings.phone || '+92 300 1234567'}
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              type="email"
              name="email"
              defaultValue={settings.email || 'info@thabba.local'}
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <input
              type="text"
              name="address"
              defaultValue={settings.address || 'Suite 404, Main Boulevard, Lahore, Pakistan'}
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <input
              type="text"
              name="public_tagline"
              defaultValue={settings.public_tagline || 'Your journey, managed with care.'}
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:outline-none focus:border-amber-500"
            />
          </div>
