              ...
              {data.expenses.length === 0 ? (
                ...
                data.expenses.map((e) => (
                  <tr key={e.id} className="hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-3 py-3 text-slate-300 font-mono whitespace-nowrap">{formatDate(e.expenseDate)}</td>
                    <td className="px-3 py-3 font-bold text-white whitespace-nowrap">{e.category}</td>
                    <td className="px-3 py-3 text-slate-400 whitespace-nowrap">{e.description || '-'}</td>
                    <td className="px-3 py-3 text-slate-400 whitespace-nowrap">{e.branch?.name || '-'}</td>
                    <td className="px-3 py-3 font-bold text-rose-400 whitespace-nowrap">{formatMoney(e.amount, currency)}</td>
                  </tr>
                ))
              )}
            </tbody>
