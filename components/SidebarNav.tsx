      ...
      <div className="md:hidden bg-slate-900 border-b border-slate-800 p-4 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-3">
          <div className="relative w-8 h-8">
            <Image src="/logo.png" alt="Karvan e Fatima" fill className="object-contain" />
          </div>
          <span className="font-bold text-white text-sm">Karvan e Fatima</span>
        </div>
        <button
      ...
      >
        <div className="p-5 overflow-y-auto">
          ...
          <div className="flex items-center gap-3 pb-5 border-b border-slate-800">
            ...
            <div>
              <span className="font-extrabold text-sm text-white tracking-tight block leading-snug">Karvan e Fatima</span>
              <span className="text-[10px] text-amber-400 font-semibold uppercase tracking-wider">Travel & Tour</span>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-slate-800 space-y-2">
          <ThemeToggle className="w-full justify-start text-slate-300" />
